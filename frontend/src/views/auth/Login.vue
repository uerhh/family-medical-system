  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="0">
        ...
        <el-form-item>
          <el-button type="primary" size="large" style="width:100%;height:44px;font-size:16px" :loading="loading" @click="handleLogin">登 录</el-button>
        </el-form-item>
      ...
      <div class="demo-accounts">
        ...
        <div class="demo-list">
          <el-tag @click="fillDemo('admin', 'admin123')" style="cursor:pointer">管理员: admin</el-tag>
          <el-tag type="success" @click="fillDemo('testuser', '123456')" style="cursor:pointer">用户: testuser</el-tag>
        </div>
      </div>
    </div>
  </div>
...
.login-header h2 { margin: 0 0 4px; color: #303133; font-size: 24px; }
...
.demo-accounts { margin-top: 10px; }
.demo-list { display: flex; justify-content: center; gap: 12px; }
</style>
